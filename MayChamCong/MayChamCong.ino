...
/*==================Clear du lieu ngay===================*/
      server.on("/clearngay01", []{
        clearFFS(filename[0]);  
        server.send(200, "text/html","Clear success");
      });                  
      server.on("/clearngay02", []{
        clearFFS(filename[1]);  
        server.send(200, "text/html","Clear success");
      });                  
      server.on("/clearngay03", []{
        clearFFS(filename[2]);  
        server.send(200, "text/html","Clear success");
      });                  
      server.on("/clearngay04", []{
        clearFFS(filename[3]);  
        server.send(200, "text/html","Clear success");
      });                  
      server.on("/clearngay05", []{
        clearFFS(filename[4]);  
        server.send(200, "text/html","Clear success");
      });                  
      server.on("/clearngay06", []{
        clearFFS(filename[5]);  
        server.send(200, "text/html","Clear success");
      });                  
      server.on("/clearngay07", []{
        clearFFS(filename[6]);  
        server.send(200, "text/html","Clear success");
      });                  
      server.on("/clearngay08", []{
        clearFFS(filename[7]);  
        server.send(200, "text/html","Clear success");
      });                  
      server.on("/clearngay09", []{
        clearFFS(filename[8]);  
        server.send(200, "text/html","Clear success");
      });                  
      server.on("/clearngay10", []{
        clearFFS(filename[9]);  
        server.send(200, "text/html","Clear success");
      });                  
      server.on("/clearngay11", []{
        clearFFS(filename[10]);  
        server.send(200, "text/html","Clear success");
      });                  
      server.on("/clearngay12", []{
        clearFFS(filename[11]);  
        server.send(200, "text/html","Clear success");
      });                  
      server.on("/clearngay13", []{
        clearFFS(filename[12]);  
        server.send(200, "text/html","Clear success");
      });                  
      server.on("/clearngay14", []{
        clearFFS(filename[13]);  
        server.send(200, "text/html","Clear success");
      });                  
      server.on("/clearngay15", []{
        clearFFS(filename[14]);  
        server.send(200, "text/html","Clear success");
      });                  
      server.on("/clearngay16", []{
        clearFFS(filename[15]);  
        server.send(200, "text/html","Clear success");
      });                  
      server.on("/clearngay17", []{
        clearFFS(filename[16]);  
        server.send(200, "text/html","Clear success");
      });                  
      server.on("/clearngay18", []{
        clearFFS(filename[17]);  
        server.send(200, "text/html","Clear success");
      });                  
      server.on("/clearngay19", []{
        clearFFS(filename[18]);  
        server.send(200, "text/html","Clear success");
      });                  
      server.on("/clearngay20", []{
        clearFFS(filename[19]);  
        server.send(200, "text/html","Clear success");
      });                  
      server.on("/clearngay21", []{
        clearFFS(filename[20]);  
        server.send(200, "text/html","Clear success");
      });                    
      server.on("/clearngay22", []{
        clearFFS(filename[21]);  
        server.send(200, "text/html","Clear success");
      });  
      server.on("/clearngay23", []{
        clearFFS(filename[22]);  
        server.send(200, "text/html","Clear success");
      });                  
      server.on("/clearngay24", []{
        clearFFS(filename[23]);  
        server.send(200, "text/html","Clear success");
      });                  
      server.on("/clearngay25", []{
        clearFFS(filename[24]);  
        server.send(200, "text/html","Clear success");
      });                  
      server.on("/clearngay26", []{
        clearFFS(filename[25]);  
        server.send(200, "text/html","Clear success");
      });                  
      server.on("/clearngay27", []{
        clearFFS(filename[26]);  
        server.send(200, "text/html","Clear success");
      });                  
      server.on("/clearngay28", []{
        clearFFS(filename[27]);  
        server.send(200, "text/html","Clear success");
      });                  
      server.on("/clearngay29", []{
        clearFFS(filename[28]);  
        server.send(200, "text/html","Clear success");
      });                  
      server.on("/clearngay30", []{
        clearFFS(filename[29]);  
        server.send(200, "text/html","Clear success");
      });                    
      server.on("/clearngay31", []{
        clearFFS(filename[30]);  
        server.send(200, "text/html","Clear success");
      });                                                                                                                                                                                                                  
/*===================================================================================*/      
/*=========================================================*/    
